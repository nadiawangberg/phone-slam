...
public class RawDepthCodelabActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  ...
  public void onDrawFrame(GL10 gl) {
    ...
    try {
      ...
      System.out.println("remaining in buffer is " + points.remaining());
      System.out.println("capacity of buffer is " + points.capacity());
      System.out.println("capacity - remaining is " + (points.capacity() - points.remaining()));
